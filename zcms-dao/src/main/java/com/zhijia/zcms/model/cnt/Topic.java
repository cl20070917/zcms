package com.zhijia.zcms.model.cnt;
...
public class Topic {
	...
	public Topic(int id, String title, String keyword, int status, int recommend, Date publishDate, String author, String cname) {
		super();
		this.id = id;
		this.title = title;
		this.keyword = keyword;
